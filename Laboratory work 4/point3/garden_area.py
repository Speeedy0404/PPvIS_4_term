...
class GardenArea:
    ...
    def __init__(self, tag: str, collect, weed, water, cure, pests, fertilizer, seedlingsnew, treenew, seedlingsdel,
                 treedel, info, newday, gui=False, Viewshow_info_view=None, Viewshow_next_day_view=None) -> None:
        self.__tag = tag
        garden = SeedBed()
        trees = Orchard()
        weather = Weather()
    ...
    def processing(self, garden, trees, weather, weeding, watering, fertillizer, collect, weed, water, cure, pests,
                   ...
                   Viewshow_info_view, Viewshow_next_day_view) -> None:
