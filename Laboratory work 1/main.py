...
@click.option('--treenewdel', is_flag=True, help="Выкорчевать дерево")
...
def main(collect, weed, water, cure, pests, fertilizer, seedlingsnew, treenew, seedlingsdel, treenewdel, info, newday):
    my_garden = GardenArea("Престиж", collect, weed, water, cure, pests, fertilizer, seedlingsnew, treenew,
                           seedlingsdel, treenewdel, info, newday)
